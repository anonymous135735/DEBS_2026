...
*/
		// load/set basic configuration
		Util.checkThenCreateZooNode(path + "/" + config_path,null,Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.p1_preexecution_number,String.valueOf(MRPUtils.P1_PREEXECUTION_NUMBER).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.p1_resend_time,String.valueOf(MRPUtils.P1_RESEND_TIME).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);	
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.concurrent_values,String.valueOf(MRPUtils.CONCURRENT_VALUES).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.value_size,String.valueOf(MRPUtils.VALUE_SIZE).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.value_count,String.valueOf(MRPUtils.VALUE_COUNT).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.batch_policy,String.valueOf(MRPUtils.BATCH_POLICY).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.value_resend_time,String.valueOf(MRPUtils.VALUE_RESEND_TIME).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.quorum_size,String.valueOf(MRPUtils.QUORUM_SIZE).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.stable_storage,String.valueOf(MRPUtils.STABLE_STORAGE).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.tcp_nodelay,String.valueOf(MRPUtils.TCP_NODELAY).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.tcp_crc,String.valueOf(MRPUtils.TCP_CRC).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);	
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.buffer_size,String.valueOf(MRPUtils.BUFFER_SIZE).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.learner_recovery,String.valueOf(MRPUtils.LEARNER_RECOVERY).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.trim_modulo,String.valueOf(MRPUtils.TRIM_MODULO).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.trim_quorum,String.valueOf(MRPUtils.TRIM_QUORUM).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(path + "/" + config_path + "/" + ConfigKey.auto_trim,String.valueOf(MRPUtils.AUTO_TRIM).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		l = zoo.getChildren(path + "/" + config_path,false);
		for(String k : l){
			String v = new String(zoo.getData(path + "/" + config_path + "/" + k,false,null));
			configuration.put(k,v);
		...
		// load/set multi ring paxos configuration
		Util.checkThenCreateZooNode(prefix + "/" + config_path,null,Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(prefix + "/" + config_path + "/" + ConfigKey.multi_ring_lambda,String.valueOf(MRPUtils.MULTI_RING_LAMBDA).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(prefix + "/" + config_path + "/" + ConfigKey.multi_ring_delta_t,String.valueOf(MRPUtils.MULTI_RING_DELTA_T).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(prefix + "/" + config_path + "/" + ConfigKey.deliver_skip_messages,String.valueOf(MRPUtils.DELIVER_SKIP_MESSAGES).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		Util.checkThenCreateZooNode(prefix + "/" + config_path + "/" + ConfigKey.multi_ring_start_time,String.valueOf(MRPUtils.MULTI_RING_START_TIME).getBytes(),Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT,zoo);
		l = zoo.getChildren(prefix + "/" + config_path,false);
		for(String k : l){
			String v = new String(zoo.getData(prefix + "/" + config_path + "/" + k,false,null));
			configuration.put(k,v);
